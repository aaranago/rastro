...
const foundReportIds = {
  first: "33333333-3333-4333-8333-000000000001",
} as const;
...
describe("Found Pet Report public detail", () => {
  it("lets a visitor read a published Found Pet Report without exposing exact coordinates by default", async () => {
    ...
    expect(detail).toMatchObject({
      ...
      shareTarget: {
        appDeepLink: `rastro://reportes/encontrados/${foundReportIds.first}`,
        path: `/reportes/encontrados/${foundReportIds.first}`,
        title: "Mascota encontrada: Perro",
        webUrl: `https://rastro.bo/reportes/encontrados/${foundReportIds.first}`,
      },
