...
function ContactOptionSection({
  ...
  return (
    <Section title="Contacto">
      <View style={styles.optionStack}>
        {viewModel.contact.options.map((option) => (
          <Pressable
            accessibilityRole="button"
            key={option.value}
            onPress={() =>
      ...
      {viewModel.contact.whatsappField.visible ? (
        <Field
          ...
          field={viewModel.contact.whatsappField}
          onChangeText={(value) =>
            setDraft((current) => ({
              ...current,
              contact: {
...
function ReviewPublishSection({
  ...
  return (
    <Section title="Revisar">
      ...
      {viewModel.review.validationErrors.map((error) => (
      ...
      <Pressable
        accessibilityRole="button"
        disabled={!viewModel.canPublish || publishState === "publishing"}
        onPress={publish}
        style={({ pressed }) => [
          styles.publishButton,
          !viewModel.canPublish ? styles.disabledButton : null,
        ...
        {publishState === "publishing" ? (
          ...
          <>
            ...
            <Text maxFontSizeMultiplier={1.15} style={styles.publishText}>
              {viewModel.review.publishActionLabel}
            </Text>
          </>
        )}
      </Pressable>
...
function Field({
  ...
  return (
    <View style={styles.field}>
      ...
      />
      {field.error ? (
        <Text maxFontSizeMultiplier={1.15} style={styles.errorText}>
          {field.error}
        </Text>
      ) : null}
    </View>
...
function InfoRow({
  ...
  return (
    <View style={styles.infoRow}>
      <ReportCreationIcon color={shellColors.primary} name={icon} size={20} />
      <View style={styles.optionCopy}>
...
function ActionButton({
  ...
  return (
    ...
    >
      <ReportCreationIcon
        color={isPrimary ? shellColors.white : shellColors.primary}
        name={icon}
        size={18}
      />
      <Text
